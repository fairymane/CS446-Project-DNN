function W = back_prop_annealing(y, t, W, h_act, lamda, X1, n_hidden_nodes, n_feature, tk)
...
SD = cell(2, 1);
    for l = 2: -1 : 0
        ...
        elseif l == 1
            ...
            %size(SD{l+1})
            %tk
            dw1 =normrnd( (W{l+1}' -lamda * SD{l+1}), (lamda * tk));
            %dw1 =normrnd( (-lamda * SD{l+1}), (lamda * tk));
            W{l+1} = dw1';
        ...
        elseif l == 0
            ...
            dw2 =normrnd((W{l+1} -lamda * sd), (lamda * tk));
            %dw2 =normrnd(( -lamda * sd), (lamda * tk));
            W{l+1} = dw2; 
